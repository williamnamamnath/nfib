        ...
        <div className="container py-5">
            <div className="row g-4">
                ...
                <div className="col-12">
                    <div className="card shadow-sm border-0 info-card info-card--accent text-center" id="contact">
                        <h2 className="fw-bold mb-3">Clinic Information</h2>
                        <p className="mb-3">To contact us, consider one of the following options:</p>
                        <ul className="list-unstyled mb-0 d-flex flex-column flex-md-row gap-3">
